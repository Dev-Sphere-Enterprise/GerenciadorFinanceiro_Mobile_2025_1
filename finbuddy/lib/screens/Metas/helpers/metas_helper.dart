              ...
              content: Column(
                ...
                children: [
                  ...
                  TextButton(
                    ...
                    child: Text(
                      "Data Limite: ${DateFormat('dd/MM/yyyy').format(selectedDate)}",
                    ),
                  ),
                ],
              ),
                ...
                ElevatedButton(
                  onPressed: () async {
                    if (nomeController.text.trim().isEmpty ||
                        valorObjetivoController.text.trim().isEmpty)
                      return;

                    final valor =
                        double.tryParse(valorObjetivoController.text.trim()) ??
                        0.0;
                    final dataMap = {
